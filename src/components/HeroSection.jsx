...
import Gudari from '../assets/Gudari.jpg';
...
const HeroSection = () => {
  ...
  const handleDownload = () => {
    const downloadUrl =
      "https://drive.google.com/file/d/1jg4_AG3HOLIk3C3D3S3Ym8uxvrf_z1nH/view?usp=sharing";
    ...
    <div id="herosection">
      ...
      >
        ...
        >
          ...
          <iframe
            src="https://drive.google.com/file/d/1jg4_AG3HOLIk3C3D3S3Ym8uxvrf_z1nH/view?usp=sharing"
            width="100%"
            height="100%"
            style={{ border: "none" }}
            title="Resume"
        ...
        <div className="relative isolate px-6 pt-14 lg:px-8">
          ...
          <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-16">
            <div className="text-center">
              ...
              <h1 className="text-5xl font-bold mb-4">Hello, I'm Gudari</h1>
              <div>
                <motion.div
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
