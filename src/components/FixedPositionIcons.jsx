    ...
    >
      <Stack spacing={2}>
        <IconButton
          ...
          onClick={() =>
            handleUrl("https://www.linkedin.com/in/kasani-gudari-venkaiah/")
          }
        >
        ...
        <IconButton
          aria-label="github"
          onClick={() => handleUrl("https://github.com/GudariVenkaiahKasani")}
        >
          <GitHub className="w-5 h-5" />
        </IconButton>
        <IconButton
          aria-label="whatsapp"
          onClick={() => handleUrl("https://wa.me/+918328016560")}
        >
          <WhatsApp className="w-5 h-5" />
        </IconButton>
        <IconButton
          aria-label="Email"
          onClick={() => handleUrl("mailto:gudari183@gmail.com")}
        >
